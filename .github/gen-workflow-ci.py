...
def main():
    ...
    def publish_docker_images(needs: List[str], images: List[str]) -> str:
        ...
        return (f'  docker-config:\n'
                ...
                f'\n'
                f'          echo ::endgroup::\n'
                f'          for dir in /home/runner/runners/*.tgz \\\n'
                f'                     /usr/lib/google-cloud-sdk \\\n'
                f'                     /usr/lib/mono \\\n'
                f'                     /usr/local/lib/android \\\n'
                f'                     /usr/local/share/chromium \\\n'
                f'                     /usr/share/dotnet \\\n'
                f'                     /opt/ghc \\\n'
                f'                     /opt/google/chrome \\\n'
                f'                     /opt/hostedtoolcache/go \\\n'
                f'                     /opt/hostedtoolcache/CodeQL\n'
                f'          do\n'
                f'            echo ::group::Deleting "$dir"\n'
                f'            sudo du -hsc $dir | tail -n1 || true\n'
                f'            sudo rm -rf $dir\n'
                ...
                f'          load: true\n'
                f'          push: false\n'
                f'          tags: horovod/${{{{ matrix.docker-image }}}}:latest\n'
                f'\n'
                f'      - name: Docker prune\n'
                f'        run: |\n'
                f'          echo ::group::Disk space before\n'
                f'          df -h\n'
                f'          echo ::endgroup::\n'
                f'\n'
                f'          echo ::group::Docker prune\n'
                f'          docker system prune --force\n'
                f'          echo ::endgroup::\n'
                f'\n'
                f'          echo ::group::Disk space after\n'
                f'          df -h\n'
                f'          echo ::endgroup::\n'
                f'\n'
                ...
                f'        with:\n'
                f'          sarif_file: ${{{{ steps.scan.outputs.sarif }}}}\n'
                f'\n'
