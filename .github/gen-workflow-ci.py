...
def main():
    ...
    def build_and_test_macos(id: str, name: str, needs: List[str], attempts: int = 3) -> str:
        ...
        return (f'  {id}:\n'
                ...
                f'            MXNET: 1.5.1.post0\n'
                f'\n'
                f'          - image: test-cpu-gloo-py3_8-tf2_5_1-keras2_5_0rc0-torch1_9_1-mxnet1_7_0_p2\n'
                ...
                f'            MXNET: 1.7.0.post2\n'
                f'\n'
                f'          - image: test-openmpi-cpu-gloo-py3_8-tf2_6_0-keras2_6_0-torch1_10_0-mxnet1_8_0_p0\n'
                f'            HOROVOD_WITH_MPI: 1\n'
                f'            HOROVOD_WITH_GLOO: 1\n'
                f'            TENSORFLOW: 2.6.0\n'
                f'            KERAS: 2.6.0\n'
