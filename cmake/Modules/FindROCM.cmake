...
list(APPEND CMAKE_PREFIX_PATH ${HOROVOD_ROCM_HOME})
list(APPEND CMAKE_MODULE_PATH ${HOROVOD_ROCM_HOME}/lib/cmake/hip)
...
if(HIP_FOUND)
  ...
  find_library(ROCM_LIBRARIES NAMES ${hip_library_name} HINTS ${HOROVOD_ROCM_HOME}/lib)
endif()
set(ROCM_INCLUDE_DIRS "${HIP_INCLUDE_DIRS} ${HOROVOD_ROCM_HOME}/include")
set(ROCM_COMPILE_FLAGS "-D__HIP_PLATFORM_AMD__=1")
