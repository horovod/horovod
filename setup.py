...
gloo_lib = CMakeExtension('gloo', cmake_lists_dir='third_party/gloo',
                          sources=[])
parasail_cuda_lib = CMakeExtension('parasail_cuda_kernels', cmake_lists_dir='horovod/common/ops/cuda',
                          sources=[])
...
def get_common_options(build_ext):
    ...
    SOURCES = ['horovod/common/common.cc',
               ...
               'horovod/common/ops/parasail_operations.cc',
    ...
    if have_cuda:
        ...
        SOURCES += ['horovod/common/ops/parasail_cuda_operations.cc',
                    'horovod/common/ops/parasail_cuda_ring_operations.cc']
        LIBRARY_DIRS += cuda_lib_dirs
...
def build_mx_extension(build_ext, global_options):
    ...
    if mx_have_cuda and not macro_have_cuda:
        ...
        options['SOURCES'] += ['horovod/common/ops/parasail_cuda_operations.cc',
                                'horovod/common/ops/parasail_cuda_ring_operations.cc']
...
class custom_build_ext(build_ext):
    def build_extensions(self):
        ...
        if check_macro(options['MACROS'], 'HAVE_CUDA'):
            ...
            build_cmake(self, ext=parasail_cuda_lib, prefix='parasail_cuda', additional_flags=[], options=options)
...
setup(name='horovod',
      ...
      ext_modules=[tensorflow_mpi_lib, torch_mpi_lib, torch_mpi_lib_impl,
                   torch_mpi_lib_v2, mxnet_mpi_lib, gloo_lib, parasail_cuda_lib],
