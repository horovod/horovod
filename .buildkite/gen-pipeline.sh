...
baseline="test-cpu-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0"
...
tests=$(if [[ -n "${PIPELINE_MODE:-}" ]] && ( [[ "${BUILDKITE_BRANCH:-}" == "${BUILDKITE_PIPELINE_DEFAULT_BRANCH:-}" ]] || [[ -n "$code_files" ]] ); then
  ...
  printf "test-cpu-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_3_2 "
  # our baseline
  printf "$baseline "

  # then we vary the baseline along mpi kinds dimension
  # our baseline again
# printf "test-cpu-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  printf "test-cpu-mpich-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  printf "test-cpu-oneccl-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  printf "test-cpu-openmpi-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  # note: we test openmpi-gloo mpi kind in this variation in each of [cpu, gpu, mixed]
  printf "test-cpu-openmpi-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  ...
  printf "test-cpu-gloo-py3_9-tf2_15_1-keras3_2_1-torch2_1_2-mxnet1_7_0_p2-pyspark3_4_0 "
  printf "test-cpu-gloo-py3_9-tf2_16_2-keras3_3_3-torch2_2_2-mxnet1_8_0_p0-pyspark3_4_0 "
  # our baseline again
# printf "test-cpu-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  ...
  printf "test-gpu-gloo-py3_8-tf1_15_5-keras2_2_4-torch2_1_2-mxnet1_8_0_p0-pyspark3_4_0 "
  printf "test-gpu-gloo-py3_9-tf2_15_1-keras3_2_1-torch2_1_2-mxnet1_8_0_p0-pyspark3_4_0 "
  printf "test-gpu-gloo-py3_9-tf2_16_2-keras3_3_3-torch2_2_2-mxnet1_8_0_p0-pyspark3_4_0 "
  printf "test-gpu-openmpi-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
  ...
  printf "test-mixed-openmpi-gloo-py3_9-tf2_17_0-keras3_4_1-torch2_3_1-mxnet1_9_1-pyspark3_4_0 "
