...
baseline="test-cpu-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1"
...
tests=$(if [[ -n "${PIPELINE_MODE:-}" ]] && ( [[ "${BUILDKITE_BRANCH:-}" == "${BUILDKITE_PIPELINE_DEFAULT_BRANCH:-}" ]] || [[ -n "$code_files" ]] ); then
  ...
  printf "test-cpu-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_4_3 "
  # our baseline
  printf "$baseline "

  # then we vary the baseline along mpi kinds dimension
  # our baseline again
# printf "test-cpu-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  printf "test-cpu-mpich-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  printf "test-cpu-oneccl-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  printf "test-cpu-openmpi-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  # note: we test openmpi-gloo mpi kind in this variation in each of [cpu, gpu, mixed]
  printf "test-cpu-openmpi-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  ...
  printf "test-cpu-gloo-py3_9-tf2_18_1-keras3_8_0-torch2_5_1-mxnet1_7_0_p2-pyspark3_5_1 "
  printf "test-cpu-gloo-py3_9-tf2_19_0-keras3_9_2-torch2_6_0-mxnet1_8_0_p0-pyspark3_5_1 "
  # our baseline again
# printf "test-cpu-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  ...
  printf "test-gpu-gloo-py3_9-tf2_18_1-keras3_8_0-torch2_5_1-mxnet1_8_0_p0-pyspark3_5_1 "
  printf "test-gpu-gloo-py3_9-tf2_19_0-keras3_9_2-torch2_6_0-mxnet1_8_0_p0-pyspark3_5_1 "
  printf "test-gpu-openmpi-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
  ...
  printf "test-mixed-openmpi-gloo-py3_9-tf2_20_0-keras3_10_0-torch2_7_1-mxnet1_9_1-pyspark3_5_1 "
