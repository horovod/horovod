...
baseline="test-cpu-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2"
...
tests=$(if [[ "${BUILDKITE_BRANCH:-}" == "${BUILDKITE_PIPELINE_DEFAULT_BRANCH:-}" ]] || [[ -n "$code_files" ]]; then
  ...
  printf "test-cpu-gloo-py3_7-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark2_4_8 "
  printf "test-cpu-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_0_3 "
  # our baseline
  printf "$baseline "

  # then we vary the baseline along mpi kinds dimension
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
  printf "test-cpu-mpich-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
  printf "test-cpu-oneccl-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
  printf "test-cpu-openmpi-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
  # note: we test openmpi-gloo mpi kind in this variation in each of [cpu, gpu, mixed]
  printf "test-cpu-openmpi-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
...
# printf "test-cpu-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
  ...
  printf "test-mixed-openmpi-gloo-py3_8-tf2_5_0-keras2_4_3-torch1_9_0-mxnet1_8_0_p0-pyspark3_1_2 "
fi)
