...
# printf "test-cpu-gloo-py3_8-tf2_11_0-keras2_11_0-torch1_13_0-mxnet1_9_1-pyspark3_3_1 "
  ...
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_11_0-keras2_11_0-torch1_13_0-mxnet1_9_1-pyspark3_3_1 "
  printf "test-cpu-gloo-py3_8-tf2_12_0rc1-keras2_12_0rc1-torch1_13_0-mxnet2_0_0b1-pyspark3_4_0rc1 "
  ...
  printf "test-gpu-gloo-py3_8-tf2_12_0rc1-keras2_12_0rc1-torch1_13_0-mxnet2_0_0b1-pyspark3_4_0rc1 "
  ...
  printf "test-mixed-openmpi-gloo-py3_8-tf2_11_0-keras2_11_0-torch1_13_0-mxnet1_9_1-pyspark3_3_1 "
   ...
   | if [[ "${PIPELINE_MODE:-}" == "GPU RCS" ]]; then sed -E "s/ /\n/g" | grep -E -e "-tf[0-9_]+rc[0-9]+-" -e "-keras[0-9_]+rc[0-9]+-" -e "-mxnet[0-9_]+a[0-9]+-" | paste -s -d " " -; else cat; fi \
