...
For more details on installing Horovod with Nvidia GPU support, read `Horovod on GPU <docs/gpus.rst>`_.

For more details on installing Horovod with Intel GPU support, read `Horovod on Intel GPU <docs/intel_gpus.rst>`_.
