...
def RemoteTrainer(estimator, metadata, ckpt_bytes, run_id, dataset_idx, train_rows, val_rows, avg_row_size, is_legacy):
    ...
    def train(serialized_model):
        ...
        with remote_store.get_local_output_dir() as run_output_dir:
            ...
            # Limit progress bar the detailed loss and metrics is avaialbe in logger,
            # no need to print in screen here.
            # But user can override this in trainer_args
            progress_bar_refresh_rate = _train_steps_per_epoch // 2
