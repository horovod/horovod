...
class BaseSettings(object):
    def __init__(self, num_proc=None, verbose=0, ssh_port=None, extra_mpi_args=None, key=None,
                 timeout=None, output_filename=None, run_func_mode=None, nic=None, elastic=False):
        """
