...
// uniformaly sample layers with given number of samples per layer
template <typename T, typename SizeT>
__global__
void sample_kernel2(
  T           *elements,
...
// Selecting elements based on a threshold, and compacting the selected
// elements and the coresponding indices
...
// Select elements using per layer threshold, and compact
template <typename T, typename IndexT, typename SizeT, typename CounterT>
__global__
void select_kernel3(
  T      *elements,
