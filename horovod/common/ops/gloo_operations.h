...
namespace horovod {
  namespace common {
    ...
    class IGlooAlgorithms {
      ...
      virtual void Allgather(void *buffer_data, void *buffer_out, int *recvcounts, int *displcmnts) = 0;
    ...
    class GlooAlgorithms : public IGlooAlgorithms {
      ...
      void Allgather(void *buffer_data, void *buffer_out, int *recvcounts, int *displcmnts) override;
